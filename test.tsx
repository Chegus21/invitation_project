...
`;
  ...
  return (
    <div className="font-sans text-gray-800 ">
      ...
      {/* Padres */}
      {caps.features.parentsSection &&
        (data.parentsNames?.length || data.godparentsNames?.length) && (
              ...
              >
                <div className="mb-6">
                  ...
                  <p className="text-2xl md:text-3xl italianno-regular text-black/80 drop-shadow-lg mt-8r">
                    Con el amor y el apoyo incondicional de quienes nos dieron
                    la vida
                  </p>
                </div>
      ...
      {caps.features.calendar && data.eventDate && (
        <section
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 text-3xl md:text-4xl mb-16 mx-auto italianno-regular leading-relaxed text-center">
                Personas especiales que nos acompañan en este momento tan
      ...
      {caps.features.locations &&
        (data.churchAddress || data.receptionAddress) && (
          <section
                  ...
                  >
                    ...
                    <div className="p-6 text-center">
                      <p className="text-black/80 montserrat-custom text-base mb-1">
                        <strong>Hora:</strong>{" "}
                        {data.timeline?.find(e => e.event.toLowerCase().includes("ceremonia"))?.time || "17:00"}
                  ...
                  >
                    ...
                    <div className="p-6 text-center">
                      <p className="text-black/80 text-base montserrat-custom mb-1">
                        <strong>Hora:</strong>{" "}
                        {data.timeline?.find(e => e.event.toLowerCase().includes("recepción"))?.time || "17:00"}
      ...
      {/* Itinerario */}
      {caps.features.timeline && data.timeline?.length ? (
        <section
        ...
        >
          ...
          >
            ...
            <p className="text-gray-700 text-lg md:text-xl mb-16 max-w-3xl mx-auto leading-relaxed montserrat-custom">
              Sigue el progreso del evento en tiempo real con esta elegante
              línea del tiempo
            </p>
          </motion.div>
      ...
      {/* Video */}
      {caps.features.video && data.customization?.videoUrl && (
        <section>
          {/* ...Iframe o reproductor del video proporcionado... */}
        </section>
      )}

      {/* Confirmar Asistencia */}
      {caps.features.rsvp &&
        (data.googleFormsLink || data.phone || data.whatsapp) && (
          <section
      ...
      {/* Background Music */}
      {caps.features.music && data.musicLink && (
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
